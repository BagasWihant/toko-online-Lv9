        ...
        <div class="card-body pt-sm-3 pt-0  navbar-vertical">
            ...
            <div class="menu">
                <div class="item"><a class="nav-link d-block">
                        <div class="row">
                            <div class="col-6">
                                <input type="number" class="form-control" id="floatingInput" placeholder="Min. Harga">
                            </div>
                            <div class="col-6">
                                <input type="number" class="form-control" id="floatingInput1" placeholder="Max. Harga">
                            </div>
                        </div>
                </div>
